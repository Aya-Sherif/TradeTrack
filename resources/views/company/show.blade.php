...
<div class="main_content_container">
    <div class="main_container main_menu_open">
        <div class="page_content">
            <h1 class="heading_title">كشف حساب : {{ $company->name }}</h1>
            ...
            <div class="client_balance" style="background-color: #f8f9fa; padding: 10px; margin-bottom: 10px; border-radius: 5px; border: 0.5px solid #dee2e6;">
                <!-- Filter Form -->
                <form method="GET" action="{{ route('companies.show', $company->id) }}" class="mb-4">
                ...
                <div class="row" style="display: flex; justify-content: flex-start; text-align: right;">
                    <h3 style="font-size: 2rem; font-weight: bold; color: #007bff; margin-left: 60px; margin-right: 30px;">
                        صافي الحساب :
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item['type'] == 'transaction')
                                    <!-- Edit button for transactions -->
                                    <a href="{{ route('transactions.edit', ['companyId' => $company->id, 'transaction' => $item['item_id']]) }}"
                                ...
                                @elseif ($item['type'] == 'payment')
                                    ...
                                    <a href="{{ route('pays.edit', ['companyId' => $company->id, 'pay' => $item['item_id']]) }}"
                                       class="btn btn-default btn-warning" data-toggle="tooltip" data-placement="top"
